...
<div style="background-color: blue; display:flex; border-radius: 5px; padding: 10px; color: white; font-family: Arial, sans-serif;">
  <div style="margin: 5px 0;">HTML</div>
  <div style="margin: 5px 0;">CSS</div>
  <div style="margin: 5px 0;">JavaScript</div>
  <div style="margin: 5px 0;">ReactJs</div>
</div>
